// soc_tb — runs the SoC and reads what it says on its serial line.
//
...
module soc_tb;
    ...
    // The clock is all the SoC needs: its power-on reset holds the core
    // for the first eight edges, exactly as it does on the board.
    always #HALF clk = ~clk;
    ...
    initial begin
        ...
        forever begin
            ...
            if (uart_tx !== 1'b0) begin
                $display("soc_tb: glitch on uart_tx at %0t", $time);
            end else begin
