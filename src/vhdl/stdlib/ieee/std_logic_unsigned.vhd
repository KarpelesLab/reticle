-- The IEEE.STD_LOGIC_UNSIGNED package (a Synopsys legacy package that was
...
--
-- The package gives `std_logic_vector` the arithmetic of an unsigned
...
end package std_logic_unsigned;
